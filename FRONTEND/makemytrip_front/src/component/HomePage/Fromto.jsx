  ...
  return (
    <Fromtocss>
      ...
      <div className="fromtodiv2">
        <div>
          <h3>DEPARTURE</h3>
          <input type="date" className="date" name="departureDate" onChange={handleDepartureDateChange} value={departureDate} />
        </div>
        <div>
          <h3>RETURN</h3>
          <input type="date" className="date" name="returnDate" onChange={handleReturnDateChange} value={returnDate} />
        </div>
        <div>
          <h3>TRAVELLER & CLASS</h3>
          <select name="travellerClass" onChange={handleTravellerClassChange} value={travellerClass}>
